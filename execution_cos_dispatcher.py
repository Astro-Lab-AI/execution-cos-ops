...
CRM_SHEET_ID = "1pghtSrFhXcoINyJNLAaMhHTffXCRkKgVyCPlJtSnntU"
CRM_TAB = "Master Pilotos Summary"
ELIGIBLE_STAGES = {"execution", "production"}
...
def fetch_eligible_projects() -> list[Project]:
    ...
    COL_STAGE = "D"       # "execution" / "production" / etc
    COL_FOLDER_URL = "E"  # Google Drive folder link for the project
    RANGE = f"{CRM_TAB}!{COL_AL_ID}2:{COL_FOLDER_URL}1000"  # row 1 assumed header
